		...
		<div className="wrap-contact100">
			<form className="contact100-form validate-form" onSubmit={actualizarAlumnoApi}>
				...
				<div className="wrap-input100 validate-input" >
					...
					<input className="input100" type="text" id="nombre" placeholder="Introduce tu nombre" defaultValue={JSON.stringify(stalumno.alumno?.nombre)?.replaceAll('"', '')}/>
				...
				<div className="wrap-input100 validate-input" >
					...
					<input className="input100" type="text" id="fechanacimiento"  defaultValue= {new Date(parseInt(JSON.stringify(stalumno.alumno?.fechanacimiento))|| 0)?.toISOString().split('T')[0]}/>
					<span className="focus-input100"></span>
				</div>
