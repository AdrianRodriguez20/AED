...
<body class='snippet-body'>
            ...
            <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    <li class="nav-item active">
                        <a class="nav-link" href="/Cliente/GestorAlumno">Alumno</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/Cliente/GestorMatricula">Matrícula</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link " href="/Cliente/GestorAsignatura">Asignatura</a>
                    </li>
                </ul>
    ...
    <div class="container mt-5">
        <div class="row ">
            ...
            <div class="col-md-4">
                <div class="wrimagecard wrimagecard-topimage">
                    <a href="/Cliente/GestorMatricula">
                        <div class="wrimagecard-topimage_header text-center" style="background-color:#8CC0FF">
            ...
            <div class="col-md-4">
                <div class="wrimagecard wrimagecard-topimage">
                    <a href="/Cliente/GestorAsignatura">
                        <div class="wrimagecard-topimage_header text-center" style="background-color:#8CC0FF">
