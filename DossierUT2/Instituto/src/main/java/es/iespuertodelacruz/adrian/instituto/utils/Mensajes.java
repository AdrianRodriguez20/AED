...
public abstract class Mensajes {
    ...
    public static final String STUDENT_UPDATE_ERROR_DUPLICATE = "El Alumno no se ha podido actualizar. Ya existe en la base de datos.";

    public static final String STUDENT_FIND_SUCCESS = "El Alumno se ha encontrado correctamente.";
    public static final String STUDENT_FIND_ERROR = "El Alumno no se ha podido encontrar.";
    ...
    public static final String STUDENT_FIND_INCOMPLETE = "El Alumno no se ha podido encontrar. Faltan datos.";
    public static final String STUDENT_FIND_ERROR_DUPLICATE = "El Alumno no se ha podido encontrar. Ya existe en la base de datos.";
