...
<head>
    ...
    <meta name="author" content="Adri·n RodrÌguez Fuentes">
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link " href="/admin/listado_peliculas.html">Gesti√≥n Peliculas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/admin/listado_categorias.html">Gesti√≥n Categorias</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="/admin/listado_actores.html">Gesti√≥n Actores</a>
                </li>
            </ul>
            <!-- USER -->
            <ul class="navbar-nav ">
