...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/sakila/GestionActores?getAll=true">Gestion Actores</a>
            </li>
        </ul>
        <!-- USER -->
        <ul class="navbar-nav ">
...
<div class="container mt-3 text-right">
    <a class="btn btn-danger addfilm" href="GestionActores?create=actor">
        Añadir Actor</a>
</div>
<div class="limiter">
                        ...
                        <c:forEach items="${actores}" var="actor">
                            <tr class="row100 body">
                                ...
                                <td class="column4">
                                    ...
                                    <a href="Actor?actor=${actor.getActorId()}" class="btn btn-primary"> <i class="far fa-eye" style="color:white"></i></a>
                                </td>
                                <td class="column5">
                                    <a href="GestionActores?actor=${actor.getActorId()}" class="btn btn-warning"> <i class="far fa-edit" style="color:white"></i></a>
                                </td>
                                <td class="column6">
