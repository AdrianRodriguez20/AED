                    ...
                    <form action="GestionActores" method="POST">
                        <div class="form-group">
                            <label for="id"><strong>ID</strong></label> <input
                                ...
                                value="${actor.getActorId()}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nombre"><strong>Nombre</strong></label> <input
                                type="text" class="form-control" id="nombre" name="nombre"
                                placeholder="Titulo" value="${actor.getFirstName()}">
                        </div>
                        <div class="form-group">
                            <label for="apellidos"><strong>Apellidos</strong></label> <input
                                type="text" class="form-control" id="apellidos" name="apellidos"
                                placeholder="Apellidos" value="${actor.getLastName()}">
                        </div>

                        <div class="text-center">
                            <button type="submit" name="submit" value="editar" class="btn btn-primary">Actualizar
                            </button>
                        </div>
